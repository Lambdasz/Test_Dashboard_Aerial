    ...
    <>
      ...
      <div className="aap-grid">
        <div className="aap-span-3">
          <ChartCard
            title="Layers"
            desc="Manajer layer. User bisa nyalain/matiin layer imej, batas plot, sama AOI-nya. Ini penting biar visualnya nggak bikin bingung pas analisis."
          >
            ...
            <div className="aap-flex" style={{ marginTop: 12 }}>
              <Button small icon="polygon-filter">Gambar AOI</Button>
              <Button small icon="ruler">Ukur</Button>
            </div>
          </ChartCard>
        </div>
        <div className="aap-span-9">
          <ChartCard
            ...
            desc="Peta interaktif yang nunjukin lokasi asli tiap imej, batas plot, sama area of interest (AOI). Ini inti dari semua analitik spasial di platform, hasil dari semua plugin bakal ditampilin di atas peta ini."
          >
            <MapView
